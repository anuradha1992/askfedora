<html lang="en">
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <form class="navbar-form navbar-left" role="search" id="form_search">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id = "search_text" placeholder="Search or ask a question">
                        </div>
        ...
        <div id="content_header">
            <div id="content">
                <font class="bold_text" id="questions">10,799 questions</font>
                <font class="bold_text" id="sort_by">SORT BY</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#">Date</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#">Activity</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#">Answers </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#">Votes</a>
        ...
        <div id="body_content">
            <div id="container">
                <div id="left">
                    ...
                    <div class="question_panes" id="q_1">
                        <div id="container_q">
                            <div id="left_q">
                                Why does Barq's taste like sweetened Violini?
                                <div class="tags">
                                    <span class="label label-warning">server</span>&nbsp;&nbsp;
                                    <span class="label label-default">barq</span>&nbsp;&nbsp;
                                    <span class="label label-default">wololo</span>
                                </div>
                            </div>
                            <div id="right_q">
                                <font class="statistics">3&nbsp;&nbsp;12&nbsp;&nbsp;4</font><br>
                                <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true" data-toggle="tooltip" data-original-title="Likes"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon glyphicon-eye-open" aria-hidden="true" data-toggle="tooltip" data-original-title="Views"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true" data-toggle="tooltip" data-original-title="Answers"></span>
                            </div>
                            <div class="clear_q"></div>
                        </div>    
                    </div>
                    ...
                    <div class="question_panes" id="q_1">
                        <div id="container_q">
                            <div id="left_q">
                                What happens if you ignite a can of pressurized soda?
                                <div class="tags">
                                    <span class="label label-warning">server</span>&nbsp;&nbsp;
                                    <span class="label label-default">barq</span>&nbsp;&nbsp;
                                    <span class="label label-default">wololo</span>
                            ...
                            <div id="right_q">
                                <font class="statistics">2&nbsp;&nbsp;12&nbsp;&nbsp;9</font><br>
                                <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true" data-toggle="tooltip" data-original-title="Likes"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon glyphicon-eye-open" aria-hidden="true" data-toggle="tooltip" data-original-title="Views"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true" data-toggle="tooltip" data-original-title="Edits"></span>
                            </div>
                            <div class="clear_q"></div>
                        </div>    
                    </div>
                    ...
                    <div class="question_panes" id="q_1">
                        <div id="container_q">
                            <div id="left_q">
                                Why does one ever decides to drink Berq's?
                                <div class="tags">
                                    <span class="label label-warning">server</span>&nbsp;&nbsp;
                                    <span class="label label-default">barq</span>&nbsp;&nbsp;
                                    <span class="label label-default">wololo</span>
                            ...
                            <div id="right_q">
                                <font class="statistics">7&nbsp;&nbsp;19&nbsp;&nbsp;3</font><br>
                                <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true" data-toggle="tooltip" data-original-title="Likes"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon glyphicon-eye-open" aria-hidden="true" data-toggle="tooltip" data-original-title="Views"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true" data-toggle="tooltip" data-original-title="Edits"></span>
                            </div>
                ...
                <div id="right">
                    <div id = "sticky_questions">
                        <font class="bold_text">Sticky Questions</font>
                        <br><br>
                        <a href="#"><font class = "body_text">Why does one ever decide to drink Barq's?</font></a>
                        <br><br>
                        <a href="#"><font class = "body_text">Who decided to produce Barq's?</font></a>
                        <br><br>
                        <a href="#"><font class = "body_text">Is Barq's just a root beer for lame people?</font></a>
                        <br><br>
                        <a href="#"><font class = "body_text">What happens if you ignite a can of pressured soda?</font></a>
                        <br><br>
                        <a href="#"><font class = "body_text">more...</font></a>
                        <br><br>
                    </div>
                    <div id = "tags">

                        <font class="bold_text">Tags</font><br><br>
                        <p>
                            <span class="label label-warning">server</span>&nbsp;&nbsp;<span class="label label-default">barq</span>
                            <br>
                            <span class="label label-default">Wololo</span>&nbsp;&nbsp;<span class="label label-default">Panda7</span>
                            <br>
                            <span class="label label-default">server</span>&nbsp;&nbsp;<span class="label label-default">barq</span>
                            <br>
                            <span class="label label-default">Wololo</span>&nbsp;&nbsp;<span class="label label-default">Panda7</span>
                            <br>
                            <span class="label label-success">Workstation</span>
                            <br>
                            <span class="label label-primary">cloud</span>&nbsp;&nbsp;<span class="label label-default">Barq</span>
                            <br>
                            <span class="label label-default">Barq</span>
                            <br>
                        </p>
        ...
        <div class = "footer_bottom" >
            <div>
                ...
                <div>
                    <a class="footer_links" href="#">Tags</a>
                    <a class="footer_links" href="#">People</a>
                    <a class="footer_links" href="#">Badges</a>
                    <a class="footer_links" href="#">About</a>
                    <a class="footer_links" href="#">FAQs</a>
                </div>
